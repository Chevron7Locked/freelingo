...
- **Onboarding goals question**: the learning-goals step of onboarding asked "What do you want to use English for?" regardless of the selected target language. The question now names the language the learner actually chose (for example, Español for Spanish) in all ten UI languages.
...
- Dependency updates and alignment across environments.
